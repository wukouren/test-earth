    ...
    return (
      <div className="expense-content " id="expense">
              ...
              return <div>
                {isShow && <div className={'exp-cell ' + (i != 0 ? 'bt-gray' : '')}>
                  <div className="exp-cell-left ">
                    ...
                    <div className="exp-item">
                      <div className="exp-item-left">本次支付金额</div>
        ...
        <div className="attach " onClick={() => self.handelToAttach()}>
          ...
          {/* <div><span className="num">共5个</span><img className="imgNext" style={{textAlign:'center'}} src="images/next.png" width="8" alt=""/></div> */}
        </div>
      </div>
    );
  }
}
export default connect((state) => { return state })(Payment);